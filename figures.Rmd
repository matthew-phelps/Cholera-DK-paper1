...
```{r outbreakProb, fig.height=4.5, fig.width=8}
load("data/r0.Rdata")
...
## Figure S3  
Using data from all obsereved index cases from the islands of Zealand, Fuen, Lolland, Fester and Moen, we calculated the probability the presence of an index case resulting in a large outbreak, black. We varied the attack-rate threshold for what is considered a "large" outbreak (x axis). The red shadded region is the expected probability of an outbreak calculated from the 95% CI range of R0 values from Aalborg, Korsør, and Copenhagen.
